...
- 4B.4: пассивная зарядка, остывание/нагрев и расход по абсолютному времени;
- 4C: живая погода Новосибирска, fallback и динамические поля света, звука, температуры и запаха.
